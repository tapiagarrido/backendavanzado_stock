...
export class CreateStockDetalleDto {
    ...
    static create(object: { [key: string]: any }): [string?, CreateStockDetalleDto?] {

        const { stock_id, usuario_id, cantidad_ingresada, fecha_ingreso, cantidad_vendida, cantidad_merma, fecha_vencimiento, proveedor, lote, precio_compra, observacion } = object;
        ...
        return [undefined, new CreateStockDetalleDto(stock_id, usuario_id, cantidad_ingresada, fecha_ingreso, cantidad_vendida, cantidad_merma, fecha_vencimiento, proveedor, lote, precio_compra, observacion)]
    }
}